<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_sample_20230220.aspx.cs" Inherits="search_sample_20230220" %>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Haemoglobin</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_03_a" class="form-control" name="LA_03_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Haematocrit</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_04_a" class="form-control" name="LA_04_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">R.B.C.</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_05_a" class="form-control" name="LA_05_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">M.C.V</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_06_a" class="form-control" name="LA_06_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">M.C.H</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_07_a" class="form-control" name="LA_07_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">M.C.H.C</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_08_a" class="form-control" name="LA_08_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">R.D.W</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_09_a" class="form-control" name="LA_09_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">W.B.C Count</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_10_a" class="form-control" name="LA_10_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Neutrophils</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_11_a" class="form-control" name="LA_11_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Lymphocytes</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_12_a" class="form-control" name="LA_12_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Eosinophils</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_13_a" class="form-control" name="LA_13_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Monocytes</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_14_a" class="form-control" name="LA_14_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Basophils</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_15_a" class="form-control" name="LA_15_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Platelets Count</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_16_a" class="form-control" name="LA_16_a"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group row">
                                                                        <label class="col-md-4 label-control" for="projectinput5">Peripheral Film</label>
                                                                        <div class="col-md-5">
                                                                            <asp:TextBox runat="server" ID="LA_17" class="form-control" name="LA_17"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <asp:TextBox runat="server" ID="LA_18" class="form-control" name="LA_18"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-md-3 label-control" for="projectinput5">Blood Culture Result</label>
                                                                <div class="col-md-9">
                                                                    <asp:TextBox runat="server" ID="LA_19" class="form-control" name="LA_19"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <asp:Button runat="server" ID="cmdSearch" class="btn btn-primary" Text="Search" OnClick="cmdSearch_Click"></asp:Button>&nbsp;
                                                            </div>
                                                            <div class="col-md-1">
                                                                <asp:Button runat="server" ID="cmdCancel" class="btn btn-primary" Text=" Clear " OnClick="cmdCancel_Click"></asp:Button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-md-9">
