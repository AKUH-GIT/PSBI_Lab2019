...
public partial class search_sample_20230220 : System.Web.UI.Page
{
    ...
    private string SearchingCriteria(string qry)
    {
        ...
        try
        {
            ...
            if (AS1_screening_ID.Text != "__-_-____")
            {
                if (criteria != null || criteria != "")
                {
                    qry += " and a.AS1_screening_ID = '" + AS1_screening_ID.Text + "'";
                }
                else
                {
                    qry += " where a.AS1_screening_ID = '" + AS1_screening_ID.Text + "'";
                }
            }
