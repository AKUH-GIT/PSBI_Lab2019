<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_bloodculture.aspx.cs" Inherits="view_bloodculture" %>
                                    ...
                                    <li><a data-action="close"><i class="ft-x"></i></a></li>--%>
                                                ...
                                                <div class="card-content collpase show">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <asp:Button runat="server" ID="cmdSearch" class="btn btn-primary" Text="Search"></asp:Button>&nbsp;
                                                            </div>
                                                            <div class="col-md-1">
                                                                <asp:Button runat="server" ID="cmdCancel" class="btn btn-primary" Text=" Clear "></asp:Button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-md-9">
